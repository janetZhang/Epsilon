...
<%@include file="include-header.jsp" %>
	...
	<section id="right">
		<div><button id="btn-add" name="btn-add" class="addBtn  add-user">Add user</button>  
		 <input type="text" value="" placeholder="Find by name"><a href="#"><img src="../images/search.gif"></a></div>
		<div class="fm">
		<h6>Add employee</h6>
		<form>

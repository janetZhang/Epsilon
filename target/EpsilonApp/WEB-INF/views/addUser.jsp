...
<%@include file="include-header.jsp" %>
	...
	<section id="right">
		...
		<div class="form-group"><span>Date of Joining</span><span class="star">*</span><input name="doj"type="date"></div>
		<div class="form-group"><span>Date of Birth</span><input name="dob" type="date"></div>
		...
		<span>Status</span><input type="radio" id="activated" name="status" value="1" checked="checked"><label for="acivated"> Activated </label>
		<input type="radio" id="inactivated" name="status" value="2"><label for="inacivated"> Inactivated </label>
		</div>

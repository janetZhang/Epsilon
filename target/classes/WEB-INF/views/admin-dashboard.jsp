...
<body>
<div id="wrapper">
<%@include file="include-header.jsp" %><!-- jsp include directive is better for static page,included at translation timme -->
	<jsp:include page="include-left.jsp" /><!-- jsp include action is better for dynamic page,included at request time -->
	<section id="right">
		<div>
		...
		<div class="form-group"><span>Role</span>   
		       <select class="form-dropdown"  id="role" name="role">
		            <option value="">  </option>
		...
		<div class="form-group"><span>Manager</span>   
		       <select class="form-dropdown"id="manager" name="manager">
		            <option value="">  </option>
